...
namespace crudEvidencia.CRUD
{
    public partial class Horario : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'ejercicioAlcaldiaDataSet.Horario' table. You can move, or remove it, as needed.
            this.horarioTableAdapter.Fill(this.ejercicioAlcaldiaDataSet.Horario);
